...
<template lang="html">
   <div>
	   <h1>即将上映</h1>
		 <el-row :gutter="0">
		  <el-col :span="15"><div class="grid-content"><SearchElement :show="show"></SearchElement></div></el-col>
		  <el-col :span="3"><div class="grid-content"><AddElement :show="show"></AddElement></div></el-col>
		  <el-col :span="3"><div class="grid-content bg-purple-light"><DeleteElement :show="show"></DeleteElement></div>
		  </el-col>
		</el-row>
